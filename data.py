...
# 文件路径
file_path = r'node\DFA-1.testlog'
...
if __name__ == '__main__':
    ...
    df_combined=process_file_chunk(lines)
    ...
    df_combined.to_excel(output_excel_path, index=False, mode='a', header=not bool(df_existing))